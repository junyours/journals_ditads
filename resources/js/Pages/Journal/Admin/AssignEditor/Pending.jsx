                        ...
                        {assigns.data.length > 0 ? (
                            assigns.data.map((assign, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{assign.user.name}</TableCell>
                                    <TableCell>
                                                    ...
                                                    onClick={() =>
                                                        window.open(
                                                            route(
                                                                "journal.download",
                                                                {
                                                                    file: `edited_files/${assign.edited_file}`,
                                                                }
                                                            ),
                                                            "_blank"
                                                        )
            ...
            >
                <DialogContent>
                    ...
                    <div className="space-y-1">
                        <Select
                            onValueChange={(val) => setData("editor_id", val)}
                        >
                            <SelectTrigger>
...
Pending.layout = (page) => (
    <AuthenticatedLayout children={page} title="Pending Assigned Editors" />
);
