      ...
      <tbody>
        <tr style="width:100%">
          <td>
            ...
            <p
              style="font-size:15px;line-height:1.4;margin:0 0 15px;color:#3c4149">
              Welcome, This is your default password for your first login. You will be required to change your password immediately after logging in to ensure your account's security.
            </p>
            <code
              style="font-family:monospace;font-weight:700;padding:1px 4px;background-color:#dfe1e4;letter-spacing:-0.3px;font-size:21px;border-radius:4px;color:#3c4149"
              >{{ $password }}</code
            >
            <table
              align="center"
              ...
              <tbody>
                <tr>
                  <td>
                    <a
                      href="{{ config('app.url') }}"
                      style="line-height:100%;text-decoration:none;display:block;max-width:100%;mso-padding-alt:0px;background-color:#16a34a;border-radius:3px;font-weight:600;color:#fff;font-size:15px;text-align:center;padding:11px 23px 11px 23px"
                      target="_blank"
                      ><span
